...
<p>헤드_ptr -> 10 -> 15 -> 7 라는 리스트가 있다. 여기서 cursor가 리스트를 쭉 돌면서 수를 카운트해 answer에 값이 저장되게 하면 된다.</p>
...
<p>예제 : linked list는 head_ptr -> 10 -> 15 -> 7 라는 리스트가 있다. 추가하려는 entry값은 13이다. 과정은 다음과 같다.</p>

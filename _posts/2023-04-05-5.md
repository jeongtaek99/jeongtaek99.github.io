...
# 소프트웨어 개발 단계
<p>
프로그램은 자료구조 + 알고리즘이다.<br>
프로그램의 개발 단계는 다음과 같다.
<ol>
	<li> 작업 명세(프로그램의 구조와 기능을 상세하게 기술한 문서)
	<li> 솔루션 디자인(문제 해결을 위한 공식화, 알고리즘은 슈도코드로 작성가능)
	<li> 솔루션 구현(디자인을 수행하는 코드 작성)
	<li> 솔루션 분석
	<li> testing과 debugging
	<li> 시스템의 유지보수 및 evolution
	<li>  Obsolescence
</ol>
</p>
